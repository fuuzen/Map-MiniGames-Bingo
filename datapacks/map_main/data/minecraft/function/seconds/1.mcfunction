...
execute if score battle.state state matches 1.. in bingo:lobby run function battle/second
...
execute if score btw.state state matches 1.. in bingo:lobby run function boatwars/second
